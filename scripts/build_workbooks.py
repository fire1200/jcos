...
PLAN = {
    1: [
        (0, "점검", "전 영상 시청자층(아동용 여부) 전수 확인", "체크 결과 시트"),
        (1, "점검", "재생목록 5개 구성, 전 영상 배치", "재생목록 링크"),
        (2, "점검", "최종화면·타임스탬프 미설정 영상 보완", "check_metadata.py 통과"),
        (3, "제작", "썸네일 가이드 확정, 기존 상위 5개 썸네일 재제작", "썸네일 3종×5"),
        (4, "세팅", "24시간 라이브 스트림 세팅·테스트", "라이브 URL"),
        (5, "커뮤니티", "설문: 이번 주 소리 투표", "응답 수"),
        (6, "측정", "기준선 기록: 노출·CTR·AVD·트래픽 소스", "KPI 시트 W0"),
        (5, "유통", "음원 출처 정리(자체 제작·독점만), 유통사·팟캐스트 호스팅 계정 개설", "출처표, 계정"),
    ],
    2: [
