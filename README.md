...
| [@jkos_kr](https://www.youtube.com/@jkos_kr) | 입시 앱 마케팅 (중경외시 소재) | 쇼츠로 앱 설치, 롱폼으로 구독 자산. **작업 공간: [`jkos/`](jkos/README.md)** |
...
| `jkos/README.md` | **중경외시 작업 공간 입구.** 흩어져 있던 중경외시 내용 취합, 결정 기록, 할 일, 미확인 항목, 변경 이력 |
| `jkos/strategy_20260921.md` | @jkos_kr 앱 마케팅 전략. 설치 축(쇼츠)과 자산 축(롱폼) 분리, 설치 추적 설정, 검색용 주제 20개, 시즌 캘린더 |
